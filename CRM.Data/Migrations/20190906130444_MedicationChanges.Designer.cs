...
namespace CRM.Data.Migrations
{
    ...
    [Migration("20190906130444_MedicationChanges")]
    partial class MedicationChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.Access", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.AccessPostAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("AccessPostAssessment");
                });
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.FinalValues", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("AccessPostAssessmentId");
                    ...
                    b.HasIndex("AccessPostAssessmentId");

                    b.HasIndex("TreatmentRecordId");

                    b.ToTable("FinalValues");
                });
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.Supplies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.FinalValues", b =>
                {
                    b.HasOne("CRM.Core.Domain.TreatmentRecords.AccessPostAssessment", "AccessPostAssessment")
                        .WithMany()
                        .HasForeignKey("AccessPostAssessmentId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.Supplies", b =>
                {
                    b.HasOne("CRM.Core.Domain.TreatmentRecords.Access", "Access")
                        .WithMany()
