...
namespace CRM.Data.Migrations
{
    ...
    [Migration("20191009095519_AppointmentDatesIdFK")]
    partial class AppointmentDatesIdFK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Core.Domain.Appointment.AppointmentDates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("AppointmentMasterId");
                    ...
                    b.HasIndex("AppointmentMasterId");

                    b.ToTable("AppointmentDates");
                });

            modelBuilder.Entity("CRM.Core.Domain.Appointment.AppointmentMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CRM.Core.Domain.Appointment.AppointmentDates", b =>
                {
                    b.HasOne("CRM.Core.Domain.Appointment.AppointmentMaster", "AppointmentMaster")
                        .WithMany("AppointmentDates")
                        .HasForeignKey("AppointmentMasterId")
            ...
            modelBuilder.Entity("CRM.Core.Domain.TreatmentRecords.TreatmentRecordMaster", b =>
                {
                    b.HasOne("CRM.Core.Domain.Appointment.AppointmentDates", "AppointmentDate")
                        .WithMany()
