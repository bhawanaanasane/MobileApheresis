...
namespace CRM.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Admin, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Customer, onlyActiveCustomerRoles);
        }
